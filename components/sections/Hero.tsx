  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(75,196,196,0.8) 1px, transparent 1px), linear-gradient(90deg, rgba(75,196,196,0.8) 1px, transparent 1px)`,
          backgroundSize: "60px 60px",
        }}
      />

      {/* Gradient blobs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#4BC4C4] rounded-full opacity-[0.06] blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-[#22D3A5] rounded-full opacity-[0.05] blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-4xl">
          ...
          >
            ...
            <Link
              ...
              className={cn(
                ...
                "border-[#E2E0DA] bg-transparent text-[#1A2744] hover:bg-[#F0EFEC] hover:border-[#4BC4C4]/40 h-12 px-8 text-base justify-center"
              )}
            >
              See what we build →
            </Link>
          ...
          <motion.div
            ...
            custom={0.4}
            variants={fadeUp}
            className="mt-16 pt-8 border-t border-[#E2E0DA] flex flex-wrap items-center gap-8"
          >
            <div className="flex items-center gap-3">
              <div className="text-2xl font-bold text-[#1A2744]">4 weeks</div>
              <div className="text-sm text-[#4A5568] leading-tight">
                Average<br />delivery
              </div>
            </div>
            <div className="w-px h-8 bg-[#E2E0DA] hidden sm:block" />
            <div className="flex items-center gap-3">
              <div className="text-2xl font-bold text-[#1A2744]">SME</div>
              <div className="text-sm text-[#4A5568] leading-tight">
